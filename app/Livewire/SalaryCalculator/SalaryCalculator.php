    ...
    public function render()
    {
        return theme_view('livewire.salary-calculator.salary-calculator')
            ->layout(theme_layout('app'), [
                'title' => '৯ম পে স্কেল ২০২৬ বেতন ক্যালকুলেটর',
                'seo' => Seo::fromArray([
                    'title' => '৯ম পে স্কেল ২০২৬ বেতন ক্যালকুলেটর',
                    'description' => 'বাংলাদেশের সরকারি চাকরিজীবীদের জন্য ২০১৫ পে স্কেলের গ্রেড, ৯ম পে স্কেল ২০২৬ ধাপ ও কর্মস্থল অনুযায়ী ২০২৬ সালের সম্ভাব্য মূল বেতন, ভাতা ও মোট বেতন হিসাব করুন।',
                    'keywords' => 'বেতন ক্যালকুলেটর, সরকারি বেতন স্কেল ২০২৬, ৯ম পে স্কেল ২০২৬, পে স্কেল ২০১৫, মূল বেতন, বেতন হিসাব',
