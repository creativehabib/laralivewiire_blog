...
return [
    'groups' => [
        ...
        'optimize' => [
            ...
            'fields' => [
                [
                    'key' => 'optimize_enabled',
                    'label' => 'Enable optimize page speed?',
                    'type' => 'switch',
                    'default' => false,
                    'rules' => ['boolean'],
                ],
                ...
                [
                    ...
                    'description' => 'This filter reduces the transfer size of HTML files by removing attributes from tags when the specified value is equal to the default value for that attribute.',
                    'type' => 'switch',
                    'default' => false,
                    'rules' => ['boolean'],
                ],
                ...
                [
                    ...
                    'description' => 'This filter eliminates HTML, JS and CSS comments to reduce the transfer size of HTML files.',
                    'type' => 'switch',
                    'default' => false,
                    'rules' => ['boolean'],
                ],
                [
                    ...
                    'label' => 'Remove quotes',
                    'description' => 'This filter eliminates unnecessary quotation marks from HTML attributes to reduce file size.',
                    'type' => 'switch',
                    'default' => false,
                    'rules' => ['boolean'],
                ],
                [
                    ...
                    'description' => 'Defers execution of javascript in the HTML. If necessary cancel deferring in some script, use data-pagespeed-no-defer as script attribute to cancel deferring.',
                    'type' => 'switch',
                    'default' => false,
                    'rules' => ['boolean'],
                ],
        ...
        'flutter_app' => [
            ...
            'fields' => [
                [
                    'key' => 'flutter_app_name',
                    'label' => 'App name',
                    'type' => 'text',
                    'default' => 'News App',
                    'rules' => ['required', 'string', 'max:120'],
                    'hint' => 'Flutter app এ দেখানো app title।',
                ],
                [
                    'key' => 'flutter_app_version',
                ...
                [
                    'key' => 'flutter_force_update',
                    'label' => 'Force update enabled',
                    'type' => 'switch',
                    'default' => false,
                    'rules' => ['boolean'],
                    'hint' => 'চালু করলে পুরনো version user-দের update বাধ্যতামূলক করা যাবে।',
                ],
                [
                    'key' => 'flutter_min_supported_version',
                    'label' => 'Minimum supported version',
                    'type' => 'text',
                    'default' => '1.0.0',
                    'rules' => ['nullable', 'string', 'max:30'],
                    'hint' => 'এই version এর নিচে হলে app update prompt দেখান।',
                ],
                [
                    'key' => 'flutter_android_store_url',
                ...
                [
                    'key' => 'flutter_home_sections',
                    'label' => 'Home sections',
                    'type' => 'textarea',
                    'default' => '["top_news","latest","categories"]',
                    'rules' => ['nullable', 'string'],
                    'hint' => 'JSON array ফরম্যাটে section slug দিন।',
                ],
                [
                    'key' => 'flutter_enable_guest_mode',
