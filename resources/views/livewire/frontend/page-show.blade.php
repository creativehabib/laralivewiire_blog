    ...
    <article class="space-y-4">
        <div wire:loading>
            <flux:skeleton.group animate="shimmer" class="space-y-4">
                ...
                <flux:skeleton class="h-10 w-2/3 rounded" />
                <flux:skeleton class="h-4 w-36 rounded" />
                <flux:skeleton class="h-56 w-full rounded-2xl" />
                <div class="space-y-3">
                    @for ($i = 0; $i < 3; $i++)
                        <div class="space-y-2 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                            <flux:skeleton class="h-4 w-40 rounded" />
                            <flux:skeleton class="h-4 w-24 rounded" />
                            <div class="flex gap-3">
                                <flux:skeleton class="h-16 w-24 rounded-lg" />
