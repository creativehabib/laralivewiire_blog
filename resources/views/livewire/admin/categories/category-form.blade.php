...
<div class="space-y-4">
    ...
    <div class="text-sm text-gray-600">
        ...
        <a href="{{ route('blogs.categories.index') }}" class="text-blue-600">Categories</a> /
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-8">
            <div class="bg-white rounded shadow-sm border border-gray-200 p-6 space-y-4">
                ...
                <div>
                    ...
                    <div class="mt-2 flex items-center text-sm">
                        <span class="px-2 py-2 border border-r-0 rounded-l bg-gray-50 text-gray-500 text-xs">
                            {{ rtrim($baseUrl, '/') }}/
                        </span>
                ...
                <div class="px-4 py-3 space-y-3">
                    <div class="flex space-x-2">
                        <button type="button"
                                ...
                                class="bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold px-4 py-2 rounded cursor-pointer">
                            Save
                        </button>
                        <button type="button"
