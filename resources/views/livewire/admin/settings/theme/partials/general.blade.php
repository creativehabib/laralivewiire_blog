    ...
    <div>
        ...
        <div class="flex items-center gap-6">
            <label class="flex items-center text-sm text-slate-600 dark:text-slate-400 cursor-pointer">
                <input type="radio" name="seo_index" class="w-4 h-4 text-indigo-600 border-slate-300 focus:ring-indigo-500 mr-2" checked> {{ __('Index') }}
            </label>
            <label class="flex items-center text-sm text-slate-600 dark:text-slate-400 cursor-pointer">
                <input type="radio" name="seo_index" class="w-4 h-4 text-indigo-600 border-slate-300 focus:ring-indigo-500 mr-2"> {{ __('No Index') }}
            </label>
        </div>
    </div>
</div>
