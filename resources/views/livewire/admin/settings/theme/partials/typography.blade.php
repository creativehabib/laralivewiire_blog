...
<form wire:submit.prevent="saveTypography" class="space-y-6">
    ...
    <div class="space-y-4">
        <div>
            ...
            <div wire:ignore>
                <select id="primary-font-select" class="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-md bg-white dark:bg-slate-800 text-slate-900 dark:text-white outline-none">
