<form wire:submit.prevent="saveHomepage" class="space-y-8" x-data="{ activeTab: 'general', selectedBlock: 1 }">
    ...
    <div class="pt-6 border-t border-slate-200 dark:border-slate-700 flex justify-end">
        <button type="submit"
            ...
            <span wire:loading.remove wire:target="saveHomepage" class="inline-flex items-center gap-2">
                <i class="fas fa-save"></i>
                {{ __('Save Changes') }}
            </span>
            <span wire:loading wire:target="saveHomepage" class="inline-flex items-center gap-2">
