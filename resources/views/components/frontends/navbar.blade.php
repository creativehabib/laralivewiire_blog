<header class="bg-white dark:bg-slate-900/95 shadow-sm sticky top-0 z-50
    ...
    <div class="container flex items-center justify-between px-4 py-3">
        ...
        <div class="flex items-center gap-3">
            ...
            <button data-theme-toggle class="inline-flex cursor-pointer items-center justify-center w-9 h-9 rounded-full border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 transition">
