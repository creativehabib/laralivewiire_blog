...
<body class="font-sans antialiased bg-slate-100 text-slate-900 dark:bg-slate-950 dark:text-slate-100 transition-colors duration-300 ease-out {{ setting('breaking_news_position', 'top') === 'bottom' ? 'pb-10' : '' }}" style="font-size: var(--body-font-size, 16px);">
