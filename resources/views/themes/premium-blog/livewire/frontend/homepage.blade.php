<div class="container px-4 pt-6 md:pt-8 pb-8 md:pb-10 typography" wire:init="loadHomepage">
    <section class="mb-6 rounded-2xl border border-blue-200/70 dark:border-slate-700 bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-5 md:p-7 shadow-lg">
        <p class="text-xs uppercase tracking-[0.2em] text-blue-100">Premium Editorial</p>
        <h2 class="mt-1 text-2xl md:text-3xl font-bold">Modern Premium News Experience</h2>
        <p class="mt-2 text-sm md:text-base text-blue-100/90">এই থিম অ্যাক্টিভ থাকলে আপনার ব্লগে premium magazine look পাওয়া যাবে।</p>
    </section>
