...
@section('content')
    <div>
        ...
        <div class="mt-10 max-w-3xl">
            ...
            <select
                class="w-full appearance-none rounded-md border border-gray-300 bg-no-repeat bg-right px-4 py-2 pr-10 text-gray-700 outline-none transition focus:border-blue-500 focus:ring-blue-500"
                id="language"
                name="language"
