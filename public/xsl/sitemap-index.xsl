        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    thead th { background-color: #8BC34A; /* সবুজ রঙ */ color: white; font-weight: bold; }
                    tbody tr:nth-child(odd) { background-color: #f9f9f9; }
                    tbody tr:nth-child(even) { background-color: #e9e9e9; } /* হালকা গ্রে */
            ...
            <body>
                <div class="container">
                    ...
                    <p>This sitemap contains <xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"/> URLs.</p>
                    <table>
                        <thead>
                            <tr>
                                <th>URL</th>
